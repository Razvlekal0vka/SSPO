...
while cap.isOpened():  # метод isOpened() выводит статус видеопотока
    ...
    _, thresh = cv2.threshold(blur, 40, 255, cv2.THRESH_BINARY)  # метод для выделения кромки объекта белым цветом
    ...
    cv2.putText(frame1, "Motion_detection", (10, 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
